        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="md:w-1/2">
            ...
            <div className="space-y-6 text-muted-gray leading-relaxed text-base font-bold">
              <p>We offer the perfect blend of perspectives. Minh is of Australian and Vietnamese heritage and brings a global understanding of service and comfort, while Tam is a true Hanoian who provides the profound local insight that only a lifelong resident possesses. With over 12 years of combined experience designing travel in Vietnam, we bridge the gap between culture and convenience. Living locally and speaking fluent English, we curate journeys that pass our ultimate test. We only plan trips that we would confidently recommend to our own friends and family. Expect a seamless balance of authentic discovery, absolute clarity, and careful planning from the moment you land until you return home.</p>
            </div>
